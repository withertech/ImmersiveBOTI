...
public class CommandStickItem extends Item {
    ...
    private static RegistryKey<Registry<Data>> registryRegistryKey = RegistryKey.getOrCreateRootKey(new ResourceLocation(ModMainForge.MODID + ":command_stick_type"));
