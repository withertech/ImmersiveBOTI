...
public class CommandStickItem extends Item
{
	...
	private static final RegistryKey<Registry<Data>> registryRegistryKey = RegistryKey.getOrCreateRootKey(new ResourceLocation(ModMainForge.MODID + ":command_stick_type"));
	...
	{
		((ServerPlayerEntity) player).func_241151_a_(message, ChatType.GAME_INFO, Util.DUMMY_UUID);
	}
