...
public class WorldWrappingPortal extends GlobalTrackedPortal {
    ...
    public static void initWrappingPortal(
        ...
        portal.axisW = Vector3d.copy(axises.getA().getDirectionVec());
        portal.axisH = Vector3d.copy(axises.getB().getDirectionVec());
        ...
        portal.dimensionTo = serverWorld.getDimensionKey();
    }
