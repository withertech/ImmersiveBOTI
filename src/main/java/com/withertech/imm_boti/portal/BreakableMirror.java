...
public class BreakableMirror extends Mirror {
    ...
    public static BreakableMirror createMirror(
        ...
        Vector3d pos = Helper.getBoxSurfaceInversed(wallBox, facing.getOpposite()).getCenter();
        pos = Helper.putCoordinate(
            ...
            Helper.getCoordinate(
                wallArea.getCenterVec().add(
                     Vector3d.copy(facing.getDirectionVec()).scale(distanceToCenter)
                ),
                facing.getAxis()
            )
        );
        ...
        breakableMirror.dimensionTo = world.getDimensionKey();
        ...
        breakableMirror.axisW =  Vector3d.copy(dirs.getA().getDirectionVec());
        breakableMirror.axisH =  Vector3d.copy(dirs.getB().getDirectionVec());
