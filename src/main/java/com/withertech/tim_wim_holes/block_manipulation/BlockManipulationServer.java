package com.withertech.tim_wim_holes.block_manipulation;
...
public class BlockManipulationServer {
    ...
    private static boolean canPlayerReach(
        ...
        Vector3d pos = Vector3d.copyCentered(requestPos);
    ...
    public static Tuple<BlockRayTraceResult, RegistryKey<World>> getHitResultForPlacing(
        ...
        Vector3d sideVec = Vector3d.copy(side.getDirectionVec());
        Vector3d hitCenter = Vector3d.copyCentered(blockHitResult.getPos());
        ...
        if (portal == null) {
            return new Tuple<>(blockHitResult, world.getDimensionKey());
        }
    ...
    public static void processRightClickBlock(
        ...
        BlockRayTraceResult blockHitResult = packet.getRayTraceResult();
