...
{
	private static final IntBuffer sizeBuffer = GLX.make(MemoryUtil.memAllocInt(1), (p_209238_0_) ->
	{
		LWJGLMemoryUntracker.untrack(MemoryUtil.memAddress(p_209238_0_));
	});

	private static final IntBuffer dataTypeBuffer = GLX.make(MemoryUtil.memAllocInt(1), (p_209238_0_) ->
	{
		LWJGLMemoryUntracker.untrack(MemoryUtil.memAddress(p_209238_0_));
	});
