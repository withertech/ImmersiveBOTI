...
public class ShaderContextManager
{
	...
	private final Map<RegistryKey<World>, PerDimensionContext> managedContext = new HashMap<>();
	private final Map<RegistryKey<World>, PerDimensionContext> abundantContext = new HashMap<>();
