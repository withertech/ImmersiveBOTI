		...
		TardisHelper.getConsole(Objects.requireNonNull(Objects.requireNonNull(this.getWorld()).getServer()), this.getInteriorDimensionKey()).ifPresent(console ->
				console.getOrFindExteriorTile().ifPresent(exterior ->
						console.getDoor().ifPresent(door ->
						{
							...
							{
								case NORTH:
									interiorPortal.setOriginPos(door.getPositionVec().add(0, 1, -0.49));
									...
									switch (console.getTrueExteriorFacingDirection())
									{
										case NORTH:
											...
											interiorPortal.setDestination(Vector3d.copyCenteredWithVerticalOffset(console.getCurrentLocation(), 1).subtract(0, 0, 0.125));
											break;
										case WEST:
											interiorPortal.setRotationTransformation(DQuaternion.rotationByDegrees(new Vector3d(0, 1, 0), 90).toMcQuaternion());
											interiorPortal.setDestination(Vector3d.copyCenteredWithVerticalOffset(console.getCurrentLocation(), 1).subtract(0.125, 0, 0));
											break;
										case SOUTH:
											interiorPortal.setRotationTransformation(DQuaternion.rotationByDegrees(new Vector3d(0, 1, 0), 180).toMcQuaternion());
											interiorPortal.setDestination(Vector3d.copyCenteredWithVerticalOffset(console.getCurrentLocation(), 1).add(0, 0, 0.125));
											break;
										case EAST:
											interiorPortal.setRotationTransformation(DQuaternion.rotationByDegrees(new Vector3d(0, 1, 0), 270).toMcQuaternion());
											interiorPortal.setDestination(Vector3d.copyCenteredWithVerticalOffset(console.getCurrentLocation(), 1).add(0.125, 0, 0));
											break;
									}
								...
								case SOUTH:
									...
									break;
								case WEST:
									interiorPortal.setOriginPos(door.getPositionVec().add(-0.49, 1, 0));
									interiorPortal.setOrientationAndSize(
			...
			switch (door.getHorizontalFacing())
			{
				case NORTH:
					...
					switch (console.getTrueExteriorFacingDirection())
					{
						case NORTH:
							interiorPortal.setRotationTransformation(DQuaternion.rotationByDegrees(new Vector3d(0, 1, 0), 0).toMcQuaternion());
							interiorPortal.setDestination(new Vector3d((int)pos.getX() + 0.5D, pos.getY(), (int)pos.getZ() + 0.5D).add(0, 1, 0).subtract(0, 0, 0.125));
							break;
						case WEST:
							interiorPortal.setRotationTransformation(DQuaternion.rotationByDegrees(new Vector3d(0, 1, 0), 90).toMcQuaternion());
							interiorPortal.setDestination(new Vector3d((int)pos.getX() + 0.5D, pos.getY(), (int)pos.getZ() + 0.5D).add(0, 1, 0).subtract(0.125, 0, 0));
							break;
						case SOUTH:
							interiorPortal.setRotationTransformation(DQuaternion.rotationByDegrees(new Vector3d(0, 1, 0), 180).toMcQuaternion());
							interiorPortal.setDestination(new Vector3d((int)pos.getX() + 0.5D, pos.getY(), (int)pos.getZ() + 0.5D).add(0, 1, 0).add(0, 0, 0.125));
							break;
						case EAST:
							interiorPortal.setRotationTransformation(DQuaternion.rotationByDegrees(new Vector3d(0, 1, 0), 270).toMcQuaternion());
							interiorPortal.setDestination(new Vector3d((int)pos.getX() + 0.5D, pos.getY(), (int)pos.getZ() + 0.5D).add(0, 1, 0).add(0.125, 0, 0));
							break;
					}
