								...
								case NORTH:
									...
									switch (console.getTrueExteriorFacingDirection())
									{
										case NORTH:
											...
											interiorPortal.setDestination(Vector3d.copyCenteredWithVerticalOffset(console.getCurrentLocation(), 1.125).subtract(0, 0, 0.0));
											break;
										case WEST:
										...
										case SOUTH:
											...
											interiorPortal.setDestination(Vector3d.copyCenteredWithVerticalOffset(console.getCurrentLocation(), 1.125).add(0, 0, 0.0));
											break;
										case EAST:
			...
			switch (door.getHorizontalFacing())
			{
				case NORTH:
					...
					switch (console.getTrueExteriorFacingDirection())
					{
						case NORTH:
							interiorPortal.setRotationTransformation(DQuaternion.rotationByDegrees(new Vector3d(0, 1, 0), 0).toMcQuaternion());
							interiorPortal.setDestination(new Vector3d((int)pos.getX() + 0.5D, pos.getY(), (int)pos.getZ() + 0.5D).add(0, 1.125, 0).subtract(0, 0, 0.0));
							break;
						case WEST:
							interiorPortal.setRotationTransformation(DQuaternion.rotationByDegrees(new Vector3d(0, 1, 0), 90).toMcQuaternion());
							interiorPortal.setDestination(new Vector3d((int)pos.getX() + 0.5D, pos.getY(), (int)pos.getZ() + 0.5D).add(0, 1.125, 0).subtract(0.0, 0, 0));
						...
						case SOUTH:
							interiorPortal.setRotationTransformation(DQuaternion.rotationByDegrees(new Vector3d(0, 1, 0), 180).toMcQuaternion());
							interiorPortal.setDestination(new Vector3d((int)pos.getX() + 0.5D, pos.getY(), (int)pos.getZ() + 0.5D).add(0, 1.125, 0).add(0, 0, 0.0));
							break;
						case EAST:
							interiorPortal.setRotationTransformation(DQuaternion.rotationByDegrees(new Vector3d(0, 1, 0), 270).toMcQuaternion());
							interiorPortal.setDestination(new Vector3d((int)pos.getX() + 0.5D, pos.getY(), (int)pos.getZ() + 0.5D).add(0, 1.125, 0).add(0.0, 0, 0));
