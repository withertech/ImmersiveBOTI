...
public class PortalManipulation {
    ...
    public static <T extends Portal> T createReversePortal(Portal portal, EntityType<T> entityType) {
        ...
        newPortal.dimensionTo = portal.world.getDimensionKey();
    ...
    public static void initFlippedShape(Portal newPortal, GeometryPortalShape specialShape, double scale) {
    ...
    public static <T extends Portal> T createOrthodoxPortal(
        ...
        portal.dimensionTo = toWorld.getDimensionKey();
    ...
    public static Portal placePortal(double width, double height, Entity entity) {
        ...
        Vector3d axisH = Vector3d.copy(hitResult.getFace().getDirectionVec());
        Vector3d axisW = axisH.crossProduct(Vector3d.copy(lookingDirection.getOpposite().getDirectionVec()));
        Vector3d pos = Vector3d.copyCentered(hitResult.getPos())
