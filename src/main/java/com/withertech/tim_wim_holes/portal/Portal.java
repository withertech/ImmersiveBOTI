...
import com.withertech.tim_wim_holes.my_util.BoxPredicate;
import com.withertech.tim_wim_holes.my_util.Plane;
import com.withertech.tim_wim_holes.my_util.RotationHelper;
...
import com.withertech.tim_wim_holes.render.PortalRenderingGroup;
import com.withertech.tim_wim_holes.render.ViewAreaRenderer;
...
public class Portal extends Entity implements PortalLike {
    ...
    public static final UUID nullUUID = Util.DUMMY_UUID;
    ...
    public void reloadAndSyncToClient() {
        ...
        updateCache();
        McHelper.getIEStorage(this.world.getDimensionKey()).resendSpawnPacketToTrackers(this);
    }
    ...
    public boolean canTeleportEntity(Entity entity) {
        ...
        if (entity instanceof ServerPlayerEntity) {
            ...
            if (specificPlayerId != null) {
                ...
                return specificPlayerId.equals(nullUUID);
            }
        }

        return true; /*entity.isNonBoss();*/
    }
    ...
    public String toString() {
        return String.format(
            ...
            world.getDimensionKey().getLocation(), (int) getPosX(), (int) getPosY(), (int) getPosZ(),
            dimensionTo.getLocation(), (int) getDestPos().x, (int) getDestPos().y, (int) getDestPos().z,
    ...
    public static boolean isParallelPortal(Portal currPortal, Portal outerPortal) {
        return currPortal.world.getDimensionKey() == outerPortal.dimensionTo &&
            currPortal.dimensionTo == outerPortal.world.getDimensionKey() &&
    ...
    public static boolean isReversePortal(Portal a, Portal b) {
        return a.dimensionTo == b.world.getDimensionKey() &&
            a.world.getDimensionKey() == b.dimensionTo &&
